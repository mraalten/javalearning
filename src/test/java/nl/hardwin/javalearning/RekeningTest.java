...
//        Rekening rekening = new Rekening(0, "nee", persoon);
//    }
//
//    @Test(expected = IllegalStateException.class)
//    public void it_should_throw_an_error_when_saldo_is_below_zero(){
//        Rekening rekening = new Rekening(-9, "nee", persoon);
//    }
//
//    @Test
//    public void printTest() {
//        Rekening bankaccount = new Rekening(200, "ja", persoon);
...
//        Rekening bankaccount = new Rekening(5000, "ja", persoon);
//        bankaccount.geldOpnemen(500);
//
